...
namespace GTAEmblemMaker.Core
{
    internal static class OfficialCatalog
    {
        ...
        {
            new ShapeDefinition("curves/01", "01", 300, 26.17475, "M250.001,12.743c-65.465,17.909-134.538,17.909-200.002,0C33.333,8.495,16.667,4.248,0,0c98.196,26.864,201.805,26.864,300,0C283.333,4.248,266.668,8.495,250.001,12.743z", "300", "26.17"),
            new ShapeDefinition("curves/07", "07", 300, 51.42924685800673, "M199.832,22.064C270.575,3.968,293.619,24.42,300,37.412c-1.098-0.73-10.999-40.676-62.904-37.197C147.904,6.191,78.629,78.317,0,14.736C42.801,82.858,136.28,38.319,199.832,22.064z", "300", "51.43"),
            ...
            new ShapeDefinition("curves/62", "62", 300, 292.947, "M294.674,0C217.345,0,144.236,29.851,88.818,84.054C33.501,138.16,2.004,210.41,0.133,287.488L0,292.947h14.205l0.128-5.195C18.041,136.917,143.8,14.204,294.674,14.204H300V0H294.674z", "300", "292.95"),
            new ShapeDefinition("curves/66", "66", 150.903, 300, "M150,3.194h0.903V0H150C67.289,0,0,67.29,0,150c0,82.709,67.289,150,150,150h0.903v-3.194H150C69.051,296.806,3.194,230.947,3.194,150C3.194,69.051,69.051,3.194,150,3.194z", "150.9", "300"),
            new ShapeDefinition("curves/67", "67", 151.797, 300, "M150,4.972h1.797V0H150C67.29,0,0,67.29,0,150s67.29,150,150,150h1.797v-4.972H150C70.032,295.028,4.972,229.968,4.972,150C4.972,70.031,70.032,4.972,150,4.972z", "151.8", "300"),
            new ShapeDefinition("curves/71", "71", 300, 64.65605911362775, "M0,59.159l1.864,1.864C84.871-18.001,216.65-16.83,298.136,64.656L300,62.792C217.485-19.722,84.035-20.893,0,59.159z", "300", "64.66"),
            new ShapeDefinition("curves/72", "72", 300, 71.51928451486023, "M297.305,61.639C258.182,22.515,206.089,0.628,150.626,0.013C95.264-0.6,42.773,20.02,2.829,58.07L0,60.765l7.187,7.187l2.693-2.563C88.071-9.05,213.784-7.509,290.118,68.825l2.695,2.694L300,64.333L297.305,61.639z", "300", "71.52"),
            new ShapeDefinition("curves/73", "73", 300, 77.90408259281718, "M294.798,60.565C256.355,22.122,205.172,0.617,150.677,0.013C96.282-0.59,44.709,19.67,5.457,57.062L0,62.26l12.139,12.139l5.197-4.949C91.366-1.028,210.391,0.432,282.661,72.702l5.201,5.202L300,65.767L294.798,60.565z", "300", "77.9"),
            new ShapeDefinition("rounds/08", "08", 211.872, 300.001, "M211.871,186.514c0-160.721-105.938-185.515-105.938-185.515S0,25.793,0,186.514l0.164,0.045C0.131,187.719,0,188.861,0,190.035C0,251.326,47.424,301,105.934,301c58.501,0,105.938-49.674,105.938-110.965c0-1.174-0.137-2.315-0.168-3.477L211.871,186.514z", "211.87", "300"),
            new ShapeDefinition("rounds/18", "18", 262.57, 300, "M136.3,0h-10.025H0c0,0,22.953,300,131.282,300C239.617,300,262.57,0,262.57,0H136.3z", "262.57", "300"),
        });
